    ...
    <div className="mt-24">
      ...
      <div className="px-6 py-12 text-gray-800">
        ...
        <p className="text-center mb-4">
          At the upcoming ITL Conference, we will be recognizing the remarkable achievements and contributions of internationally trained lawyers (ITLs) and the stakeholders, community partners and law firms that support them...
        </p>
        <p className="text-center">
          We invite ITLs, law firms, and legal professionals across Canada to participate in this prestigious recognition of talent and dedication...
        </p>
            ...
            awards.map((award) => (
              ...
              >
                <div className="w-16 h-16 relative mb-4">
                  <Image src={award.icon} alt={award.title} layout="fill" objectFit="contain" />
                </div>
