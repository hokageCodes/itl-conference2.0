    ...
    <section id="team" className="team-area bg-[#FEFBF6] py-16 mt-16">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-[#7F5283]">Our <span className="text-[#ff5a6e]">Partners</span></h2>
          <h4 className="text-lg text-[#7F5283] mt-2">Meet our awesome partners</h4>
        </div>
